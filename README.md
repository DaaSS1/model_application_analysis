...
При необходимости доработать README под ваш CI/структуру репозитория или экспортировать `README.md` — напишите, какие разделы вы хотите изменить.

---

*README сгенерирован автоматически по содержимому ноутбука `modile_application_analysis.ipynb`. Если хотите, могу:*

* *сохранить этот README как `README.md` в репозиторий*;
* *подготовить краткий `SUMMARY.md` для менеджеров;*
* *вынести функции анализа в отдельный скрипт `analysis.py` и сопроводить unit-тестами.*
